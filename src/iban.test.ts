...
import { FieldValidationResult, FieldValidationFunction } from 'lc-form-validation';
...
describe('validateIBAN', () => {
    it('Should invalidate undefined input', () => {
        ...
        //Act
        const result = validateIBAN(testIBAN, null, null) as FieldValidationResult;
        //Assert
    ...
    it('Should validate length for diferent countries', () => {
        ...
        //Act
        const GbResult = validateIBAN(GtTestIBAN, null, null) as FieldValidationResult;
        const ItResult = validateIBAN(ItTestIBAN, null, null) as FieldValidationResult;
        //Assert
    ...
    it('Should validate with and without blankspaces', () => {
        ...
        //Act
        const result = validateIBAN(testIBAN, null, null) as FieldValidationResult;
        const resultNoSpaces = validateIBAN(noSpacesTestIBAN, null, null) as FieldValidationResult;
        //Assert
        expect(result.succeeded).toBeTruthy();
